...
import app.thutucgplx.dht.com.thutucgiaypheplaixe.activities.ListSignActivity;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        holder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                context.showDialogContent(contentDetailRules.get(i).title, contentDetailRules.get(i).detail);
            }
        });
        return view;
    }
